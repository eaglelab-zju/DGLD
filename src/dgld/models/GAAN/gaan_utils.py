...
def set_subargs(parser):
    ...
    parser.add_argument('--gen_hid_dims', nargs='+', type=int, default=[32, 64, 128], help='generator hidden dims list')
    parser.add_argument('--ed_hid_dims', nargs='+', type=int, default=[32, 64], help='discriminator hidden dims list')
    parser.add_argument('--out_dim', type=int, default=128, help='discriminator of encoder out')
